...
export default function AuthPage() {
	...
	async function handleRegister(e: React.FormEvent) {
		...
		try {
			...
			setRegisterError(
				"No se pudo crear la cuenta. Verificá que el email no esté en uso.",
			);
		} finally {
	...
	return (
        ...
        ══════════════════════════════════════ */}
				<div className="flex h-full" style={{ width: "50%" }}>
					...
					<div className="hidden md:block md:w-1/2 relative bg-surface-dark">
						...
						<div className="absolute bottom-12 left-10 right-10">
							<p className="font-serif text-display-sm text-on-dark mb-3 leading-snug">
								"Un santuario para el pensamiento reflexivo y el estudio
								deliberado."
							</p>
					...
					{/* Formulario login */}
					<div className="w-full md:w-1/2 flex items-center justify-center px-10 py-10 bg-canvas">
						<div className="w-full max-w-sm">
							...
							<form onSubmit={handleLogin} className="space-y-5">
								<div>
									<label
										htmlFor="login-email"
										className="block font-sans text-caption text-body-strong mb-1.5"
									>
										Email
									</label>
									<input
								...
								<div className="flex items-center justify-between">
									<label className="flex items-center gap-2 cursor-pointer">
										<input
											type="checkbox"
											className="h-4 w-4 text-primary border-hairline rounded"
										/>
									...
									<a
										href="#"
										className="font-sans text-caption text-primary hover:text-primary-active transition-colors"
									>
							...
							<div className="mt-6">
								<div className="relative mb-5">
									...
									<div className="relative flex justify-center">
										<span className="px-3 bg-canvas font-sans text-caption text-muted">
											O continuá con
										</span>
									</div>
								</div>
				...
				<div className="flex h-full" style={{ width: "50%" }}>
					...
					<div className="w-full md:w-1/2 flex items-center justify-center px-10 py-10 bg-canvas">
						<div className="w-full max-w-sm">
							...
							<h1 className="font-serif text-display-sm text-ink mb-1">
								Comenzá tu camino
							</h1>
									...
									{(
										...
										return (
											...
											>
												...
												/>
												<span className="material-symbols-outlined text-primary text-[22px] mb-2">
													{icon}
												</span>
												<span className="font-sans text-title-sm text-ink">
													{title}
												</span>
												<span className="font-sans text-caption text-muted mt-0.5">
													{desc}
												</span>
											</label>
										);
